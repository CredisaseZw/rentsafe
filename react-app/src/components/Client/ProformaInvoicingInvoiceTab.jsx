import useProformaInvoiceTab from "../../hooks/component-hooks/useProformaInvoiceTab.js";
...
export default function ProformaInvoicingInvoiceTab() {
  const { loading, invoiceList, handleFilters } = useProformaInvoiceTab();
