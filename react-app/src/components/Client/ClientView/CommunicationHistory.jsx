      ...
      <SectionSkeleton noBoundary title="communication history">
        <div className="custom-bg-whitesmoke px-5 py-3">
          <div className="custom-vh-50 custom-overflow-y-auto">
            {messagesToMap.map((message, index) =>
              ...
              message.communicationType === 'maintenance' ? (
                <div
                  key={index}
                  className="custom-message py-2 px-3 border shadow-sm mb-3"
                >
                  <small>
                ...
                >
                  <small>
                    {message.text +
                      (message.communicationType.toLowerCase().trim() !==
                        'note' && message.actionDone
                        ? ` (action date: ${friendlyDateAndTime(
                            message.actionDone
                          )})`
                        : '')}
                  </small>
          ...
          <form
            ...
            className="border-top border-4 w-100 pt-3"
          >
            {error && (
            ...
            <div className="d-flex flex-wrap justify-content-center pt-2 gap-2 align-items-center">
              ...
              <div className="form-check">
                ...
                <label
                  className="form-check-label"
                  htmlFor="reminder_type-reminder"
                >
                  Reminder
                </label>
              </div>
              ...
              <div className="form-check">
                ...
                <label
                  className="form-check-label"
                  htmlFor="reminder_type-inspection"
                >
                  Inspection
                </label>
              </div>
            ...
            {remainderType !== 'note' && remainderType !== 'works' && (
              <div className="d-flex my-2 gap-2 align-items-center justify-content-center">
                <label
                  htmlFor="action_date"
                  className="small d-block text-nowrap form-label"
                >
