...
export default function DebtorIntelligence({
  data: initialData,
  clientId,
  isCreditorView,
}) {
  ...
  return (
    <SectionSkeleton
      title={isCreditorView ? 'creditor intelligence' : 'customer intelligence'}
    >
        ...
        {isEditMode ? (
          ...
          <div>
            ...
            <div className="small text-success">
              {friendlyDateAndTime(data.timestamp)}
            </div>
