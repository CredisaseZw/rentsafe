...
export const ExternalUserForm = ({ show, handleClose, action, receivedData, url }) => {
  const [isLoading, setIsLoading] = useState(false);
  const [errors, setErrors] = useState("");

  const { data, setData, post, put, reset } = useForm({
    firstName: Object.keys(receivedData).length > 0 ? receivedData.firstName : "",
    lastName: Object.keys(receivedData).length > 0 ? receivedData.lastName : "",
    identificationNumber:
      Object.keys(receivedData).length > 0 ? receivedData.identificationNumber : "",
    identificationType: Object.keys(receivedData).length > 0 ? receivedData.identificationType : "",
    mobileNumber: Object.keys(receivedData).length > 0 ? receivedData.mobile : "",
    userEmail: Object.keys(receivedData).length > 0 ? receivedData.email : "",
    accessLevel: Object.keys(receivedData).length > 0 ? receivedData.access_level : "",
                      ...
                      <div className="col-md-12">
                        <div className="row">
                          <div className="col-lg-4">
                            ...
                            {errors && <div className="text-danger mt-1">{errors.accessLevel}</div>}
                          </div>
                          <div className="col-lg-4">
                            ...
                            <input
                              ...
                              className="form-control form-control-sm"
                            />
                            {errors && <div className="text-danger mt-1">{errors.userEmail}</div>}
                          </div>
                        </div>
                      </div>
                    </div>
