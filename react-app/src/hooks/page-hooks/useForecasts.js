export default function useForecasts(inflows_statement, outflows_statement) {
  ...
  const netFlows = {
    zero_to_seven_days:
      inflows_totals.zero_to_seven_days - outflows_totals.zero_to_seven_days,
    eight_to_fourteen_days:
      inflows_totals.eight_to_fourteen_days -
      outflows_totals.eight_to_fourteen_days,
    fifteen_to_twenty_one_days:
      inflows_totals.fifteen_to_twenty_one_days -
      outflows_totals.fifteen_to_twenty_one_days,
    twenty_one_plus_days:
      inflows_totals.twenty_one_plus_days -
      outflows_totals.twenty_one_plus_days,
