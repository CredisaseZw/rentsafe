        ...
        <div className="col-lg-5 col-md-6">
          <div className="card-body p-5">
            <div className="text-center">
              <img className="mb-3" src="" alt="logo" style={{ height: "48px" }} />
              <h1 className="display-5 mb-0">Welcome to CrediSafe</h1>
              <div className="subheading-1 mb-5">
                <strong>{companyName}</strong>, confirm account by inserting password below
              </div>
            </div>
...
ClientCompanyVerify.layout = (page) => <Layout children={page} title={"Account Confirmation"} />;
