            ...
            <div className="card card-raised  overflow-hidden">
              ...
              <div className="card-body p-0">
                <div className="d-flex justify-content-around mt-2 mb-2">
                  <div >
                    <Link href={reverseUrl('historic-subs-individual')} style={{color:'#176987', textDecoration:'none'}}>Individual</Link>
                  </div>
                  <div>|</div>
                  <div>
                    <Link href={reverseUrl('historic-subs-company')} style={{color:'#176987', textDecoration:'none' }}>Company</Link>
                  </div>
                </div>
              </div>
            </div>
