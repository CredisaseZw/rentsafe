...
export default function Dashboard({ individual_customers = [], company_customers = [] }) {
  ...
  const individualCustomers = individual_customers.map((customer, index) => ({
    ...
    total: (customer.individual_leases_count || 0) + (customer.company_leases_count || 0),
  }));
          ...
          <div className="row align-items-center mb-4">
            <div className="col-6">
              <div className="border shadow-sm bg-white">
                <h5 className="m-0 p-2 bg-info text-white text-center">Credit Status Check</h5>
            ...
            <div className="col-6">
              <div className="border shadow-sm bg-white">
                <h5 className="m-0 p-2 bg-info text-white text-center">View Active Leases</h5>
...
const barChatData = {
  labels: ["Jan-24", "Feb-24", "Mar-24", "Apr-24", "May-24", "Jun-24", "Jul-24"],
  datasets: [
    {
      label: "Leases - 2024",
