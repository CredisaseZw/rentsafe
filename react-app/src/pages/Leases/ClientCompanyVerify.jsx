...
const ClientCompanyVerify = () => {
  ...
  return (
    <div className="d-flex justify-content-center align-items-center h-75 w-100 gap-3 flex-column text-center p-4">
      {is_verified ? (
        <>
        <div className='d-flex justify-content-center align-items-center column text-center p-4' style={{maxHeight: '200px'}}>
          <Lottie
              animationData={done}
              allowFullScreen
              placeholder="done"
              className="w-25 h-25"
            options={{ loop: false, autoplay: true, animationData: done, rendererSettings: { preserveAspectRatio: 'xMidYMid slice' }, height: 100, width: 100}}
          />
        </div>
        ...
        <>
          ...
          <Lottie
              ...
              allowFullscreen
            className="w-50 h-50"
            options={{ loop: false, autoplay: true, animationData: done, rendererSettings: { preserveAspectRatio: 'xMidYMid slice' }, height: 200, width: 200}}
          />
          </div>
