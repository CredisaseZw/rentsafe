...
export default function CommissionStatementsSelection() {
  const { periodSelection, handleSubmit, setPeriodSelection } = useCommissionStatementsSelection();
...
CommissionStatementsSelection.layout = (page) => (
  <Layout children={page} title="Commission Statements" />
);
