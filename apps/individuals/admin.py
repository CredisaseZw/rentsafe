...
class IndividualAdmin(admin.ModelAdmin):
    list_display = ('id','last_name', 'first_name','get_mobile_phone','get_email', 'gender', 'identification_number', 'date_of_birth', 'is_verified','is_active','is_deleted',"date_created")
    ...
    get_mobile_phone.short_description = 'Mobile Phone'
