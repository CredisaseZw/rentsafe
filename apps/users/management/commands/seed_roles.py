    ...
    def handle(self, *args, **options):
        ...
        roles_data = [
            ...
            },
            {
                ...
                "permissions": [
                    # Accounting Module
                    "accounting.add_chartofaccounts",
                    "accounting.change_chartofaccounts",
                    "accounting.delete_chartofaccounts",
                    ...
                    "accounting.add_bankreconciliation",
                    "accounting.change_bankreconciliation",
                    "accounting.delete_bankreconciliation",
                    "accounting.view_bankreconciliation",
                    "accounting.add_currency",
                    "accounting.change_currency",
                    "accounting.delete_currency",
                    "accounting.view_currency",
                    "accounting.add_salesitem",
                    "accounting.change_salesitem",
                    "accounting.delete_salesitem",
                    "accounting.view_salesitem",
                    "accounting.add_salescategory",
                    "accounting.change_salescategory",
                    "accounting.delete_salescategory",
                    "accounting.view_salescategory",
                    "accounting.add_vatsetting",
                    "accounting.change_vatsetting",
                    "accounting.delete_vatsetting",
                    "accounting.view_vatsetting",
                    "accounting.add_accountsector",
                    "accounting.change_accountsector",
                    "accounting.delete_accountsector",
                    "accounting.view_accountsector",
                    "accounting.add_generalledgeraccount",
                    "accounting.change_generalledgeraccount",
                    "accounting.delete_generalledgeraccount",
                    "accounting.view_generalledgeraccount",
                    "accounting.add_ledgertransaction",
                    "accounting.change_ledgertransaction",
                    "accounting.delete_ledgertransaction",
                    "accounting.view_ledgertransaction",
                    "accounting.add_transactiontype",
                    "accounting.change_transactiontype",
                    "accounting.delete_transactiontype",
                    "accounting.view_transactiontype",
                    ...
                    "accounting.add_cashsale",
                    "accounting.change_cashsale",
                    "accounting.delete_cashsale",
                    "accounting.view_cashsale",
                    "accounting.add_creditnote",
                    "accounting.change_creditnote",
                    "accounting.delete_creditnote",
                    ...
                    "accounting.add_paymentmethod",
                    "accounting.change_paymentmethod",
                    "accounting.delete_paymentmethod",
                    "accounting.view_paymentmethod",
                    "accounting.add_cashbook",
                    "accounting.change_cashbook",
                    "accounting.delete_cashbook",
                    "accounting.view_cashbook",
                    "accounting.add_cashbookentry",
                    "accounting.change_cashbookentry",
                    "accounting.delete_cashbookentry",
                    "accounting.view_cashbookentry",
                    "accounting.add_transactionlineitem",
                    "accounting.change_transactionlineitem",
                    "accounting.delete_transactionlineitem",
                    "accounting.view_transactionlineitem",
                    "accounting.add_currencyrate",
                    "accounting.change_currencyrate",
                    "accounting.delete_currencyrate",
            ...
            },
            {
                ...
                "permissions": [
                    ...
                    "leases.delete_lease",
                    "leases.view_lease",
                    "leases.add_rentalapplication",
                    "leases.change_rentalapplication",
                    "leases.delete_rentalapplication",
                    ...
                    "maintenance.view_maintenancerequest",
                    "maintenance.add_servicevendor",
                    "maintenance.change_servicevendor",
                    "maintenance.delete_servicevendor",
                    "maintenance.view_servicevendor",
                    "communications.add_message",
            ...
            },
            {
                ...
                "permissions": [
                    ...
                    "communications.change_message",
                    "communications.view_message",
                    "marketing.add_campaign",
                    "marketing.change_campaign",
        ...
        with transaction.atomic():
            self.stdout.write(
                self.style.NOTICE("Fetching all existing permissions for validation...")
            )
            all_db_permissions = {
            ...
            for role_data in roles_data:
                ...
                if role_data["permissions"] == "__ALL__":
                    ...
                    self.stdout.write(
                        f"  Role '{role_name}': Assigning ALL {len(permissions_to_assign_objects)} existing permissions."
                    )
                else:
                    for perm_codename in role_data["permissions"]:
                        if perm_codename in all_db_permissions:
                            permissions_to_assign_objects.append(
                                all_db_permissions[perm_codename]
                            )
                        else:
                            self.stdout.write(
                                self.style.WARNING(
                ...
                if created:
                    ...
                    if role.description != role_data["description"]:
                        ...
                        role.save()
                        self.stdout.write(
                            f"  Updated description for role '{role.name}'."
                        )

                role.permissions.set(permissions_to_assign_objects)
                self.stdout.write(
                    f"  Assigned {len(permissions_to_assign_objects)} permissions to role '{role.name}'."
                )
