""" "
Filters for the general ledgers and account sectors/types and subtypes.
"""
...
class GeneralLedgerFilter(django_filters.FilterSet):
    """
    Filter for General Ledger model.
    """
...
class AccountSubTypeFilter(django_filters.FilterSet):
    """
    Filter for AccountSubType model.
    """
