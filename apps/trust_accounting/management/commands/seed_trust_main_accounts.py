"""Management command to seed the database with predefined accounts and sectors. General Ledger Accounts and Account Types are created."""
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        for entry in self.ACCOUNTS_DATA:
            ...
            TrustGeneralLedgerAccount.objects.get_or_create(
