            ...
            <div className="main-sm-card">
                <div className="flex flex-row justify-between"> 
                    <div className="flex flex-col gap-0">
                        <h2 className="text-2xl font-bold text-gray-800 dark:text-white" >{statement.primary_tenant  ?? "N/A"}</h2>
                    ...
                    <div className="flex flex-col gap-0">
                        ...
                        <p className="text-gray-500 dark:text-white"> {getCurrentDate()}</p>
                    </div>
                </div>
                <div className="mt-6">
                    <TableBase headers={TENANT_STATEMENT_HEADERS} isLoading = {isLoading} paginationName="payments" paginationData={paginationData}>
                        {   
                            !isLoading &&
                            payments.length ?
