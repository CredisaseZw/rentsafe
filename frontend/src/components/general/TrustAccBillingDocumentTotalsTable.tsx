...
import PrintBillingDocument from "../routes/rent-safe/accounting/sales/sales-invoice/PrintBillingDocument"
import useTrustAccInvoiceTotalsTables from "@/hooks/components/useTrustAccInvoiceTotalsTables"
import AutoCompleteTrustAccSalesItem from "./AutoCompleteTrustAccSalesItem"
interface props{
    cashSaleProps? : CashSaleProps, 
    isCashSales? : boolean
}

const TrustAccBillingDocumentTotalsTable = forwardRef(({isCashSales, cashSaleProps}: props, ref) => {
    const {
        rows,
        discount,
        cashBooks,
        ...
        setDiscount,    
        ResetPrompts,
    } = useTrustAccInvoiceTotalsTables(ref,isCashSales)
            ...
            rows.map((row, index)=>(
                <TableRow key={index} noHover>
                    ...
                    <TableCell className="text-end border-r border-color">
                        <AutoCompleteTrustAccSalesItem
                            index={index}
                            onSelectValue = {(item)=> handleOnSelectItem(item, index)}
...
export default TrustAccBillingDocumentTotalsTable