         ...
         <td className="td-border-color border">
            <table className="w-full table-auto">
               <tbody>
                  ...
                  <tr>
                     <td colSpan={2} className="td-border-color border-t border-r px-4 py-2">
                        <Pill variant="success">Commercial Offices</Pill>
                     </td>
                     <td colSpan={2} className="td-border-color border-t border-l px-4 py-2">
                        <span>4-Offices</span>
                     </td>
                  </tr>
                  <tr className="td-border-color border-t border-b">
                     <td className="td-border-color border-r px-4 py-2 text-center font-medium">Status</td>
                     <td className="td-border-color border-r px-4 py-2 text-center font-medium">Tenant</td>
                     <td className="td-border-color border-r px-4 py-2 text-center font-medium">Monthly Rent</td>
