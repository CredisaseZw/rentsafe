...
function TableHeader({ stickToTop, className, ...props }: React.ComponentProps<"thead"> & { stickToTop?: boolean }) {
   return (
      <thead
         data-slot="table-header"
         className={cn(
            "[&_tr]:border-b [&_tr]:hover:bg-transparent",
            stickToTop ? "sticky top-0 z-2 bg-white" : "",
            className,
         )}
         {...props}
      />
